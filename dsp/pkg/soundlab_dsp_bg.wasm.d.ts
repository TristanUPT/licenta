...
export const synth_note_off: (a: number) => void;
export const synth_note_on: (a: number, b: number) => void;
export const synth_process: (a: number, b: number, c: number) => void;
export const synth_set_param: (a: number, b: number, c: number) => void;
